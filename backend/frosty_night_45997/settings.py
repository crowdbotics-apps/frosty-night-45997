"""
Django settings for frosty_night_45997 project.
...
ROOT_URLCONF = 'frosty_night_45997.urls'
...
WSGI_APPLICATION = 'frosty_night_45997.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "frosty_night_45997 API",
    "DESCRIPTION": "API documentation for frosty_night_45997 App",
    "VERSION": "v1",
}
